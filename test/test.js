AddressHash:"go-crypto-0.5.0",PrivateKey:{Crypto:"none",Plain:"4B88599F0FC33612048FB81BDEBE864CE8B69A6FC6057FA6ECA6CC22E7EC5F00BC9B99B9C0AB895C6968DCBC8EB88637F6518AC89E281A78C230F9DB42EE6D4B"}},
  {CurveType:"ed25519",Address:"DAD5866BA4C719CA3F0D830B3B96CD6710006A86",PublicKey:"14B3EE72793A94C546A5570FFEBC65AAA436E388EEBED9C2756FDB4D7D7759D8",AddressHash:"go-crypto-0.5.0",PrivateKey:{Crypto:"none",Plain:"0EC3CB22EB4A3B78C7E389D273FB1CA468398256DDE717E06D12F85B42C36EC114B3EE72793A94C546A5570FFEBC65AAA436E388EEBED9C2756FDB4D7D7759D8"}},
  {CurveType:"ed25519",Address:"FA4501961219DCCE873A47B43352BC06DB160613",PublicKey:"9E0B9E9511B4A38A9B343839FAC57EBD17B29799991262E7449B83B706587841",AddressHash:"go-crypto-0.5.0",PrivateKey:{Crypto:"none",Plain:"77E1E4CC2EFF3D0DB439FEAC2150E2109233E4ADEF2C18482EE3E7D7DBC3E45E9E0B9E9511B4A38A9B343839FAC57EBD17B29799991262E7449B83B706587841"}}
...
//////////////////////////////////////////////////////////////
// Tendermint
describe("1- Generate publickey and address", function () {
  it("Generates Tendermint address from 32 bytes seed", function () {
    ...
    TKeys.forEach(element => {
      ...
      var address = tenderKeys.getTendermintAddress(keyPair.publicKey);
...
describe("2- Get Tendermint address from public keys", function () {
  it("All the addresse must be equal to original ones!", function () {
    var tenderKeys = new TenderKeys;

    TKeys.forEach(element => {      
      
      var address = tenderKeys.getTendermintAddress(element.pubKey);
...
describe("3- Get Tendermint address from private keys", function () {
  it("All the addresses must be equal to original ones!", function () {
    var tenderKeys = new TenderKeys;

    TKeys.forEach(element => {      
      
      var address = tenderKeys.getTendermintAddressFromPrivKey(element.privKey);      
...
describe("4- Get public key from private keys", function () {
...
/////////////////////////////////////////////////////////////////////////////
////// Hyperledger burrow keys
describe("5- Generate publickey and address for hyperledger burrow from seed", function () {
  it("The address must be equal to original ones!", function () {
    var tenderKeys = new TenderKeys;

    BKeys.forEach(element => {
    
      var seed = element.PrivateKey.Plain.substring(0,64);      
      
      var keyPair = tenderKeys.generateKeyPair(seed);
      
      var address = tenderKeys.getBurrowAddress(keyPair.publicKey);
...
describe("6- Get hyperledger burrow address from public keys", function () {
  it("All the addresse must be equal to original ones!", function () {
    var tenderKeys = new TenderKeys;

    BKeys.forEach(element => {      
      
      var address = tenderKeys.getBurrowAddress(element.PublicKey);
...
describe("7- Get hyperledger burrow address from private keys", function () {
  it("All the addresses must be equal to original ones!", function () {
    var tenderKeys = new TenderKeys;

    BKeys.forEach(element => {      
      
      var address = tenderKeys.getBurrowAddressFromPrivKey(element.PrivateKey.Plain);      
